...
syntax match cppOperator "\<std::numbers::pi\>" conceal cchar=π
syntax match cppOperator "\<M_PI\>" conceal cchar=π
...
syntax keyword cppOperator complex conceal cchar=ℂ
...
syntax match cppOperator "\<function\>" conceal cchar=λ
syntax match cppOperator "\<std::function\>" conceal cchar=λ
